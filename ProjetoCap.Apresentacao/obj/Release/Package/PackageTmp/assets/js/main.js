...
var Core = function(options) {
   ...
   var runHelpers = function() {
    ...
    // Ativando o collapse - Crsitiano Ribeiro Amaral
    var ativandoCollapse = function() {
        $('html').on('click', '.collapse-link', function (e) {
            e.preventDefault();
            var box = $(this).closest('div.panel');
            var button = $(this).find('i');
            var content = box.find('div.panel-body');

...
//function LoadDataTablesScripts(callback) {
//    function LoadDatatables() {
//        $.getScript('../../Scripts/table/bootstrap-table.min.js', function () {
//            $.getScript('../../Scripts/table/bootstrap-table.js', function () {
//                $.getScript('../../Scripts/table/bootstrap-table-filter.js', function () {
//                    $.getScript('../../Scripts/table/bs-table.js', callback);
//                });
//            });
//        });
//    }
...
//
// Function for change panels of Home
//
function HomeTabChecker() {
    $('#content').on('click', 'a.tab-link', function (e) {
        e.preventDefault();
        $('div#Home_tabs').find('div[id^=Home]').each(function () {
            $(this).css('visibility', 'hidden').css('position', 'absolute');
        });
        var attr = $(this).attr('id');
        $('#' + 'Home-' + attr).css('visibility', 'visible').css('position', 'relative');
...
//
// Helper for draw Sparkline plots on Home page
//
...
/*-------------------------------------------
	Functions for Home page (Home.html)
---------------------------------------------*/
//
...
//
// Redraw Knob charts on Home (panel- servers)
//
...
//
// Draw 3 Sparkline plot in Home header
//
...
//
// Draw Morris charts on Home (panel- Statistics - Planning + 3 donuts)
//
function MorrisHome() {
    Morris.Line({
        element: 'stat-graph',
...
//
// Draw SparkLine example Charts for Home (table- Tickers)
//
function DrawSparklineHome() {
    SparklineLoop();
...
//
// Draw Knob Charts for Home (for servers)
//
function DrawKnobHome() {
...
//
// Draw Springy graphs (Network map) on Home page
//
...
/*-------------------------------------------
	Function for get stock from Yahoo finance to Home page
---------------------------------------------*/
//
// Make stock Home page
//
...
$(document).ready(function () {
    ...
    //    //ajax_url = 'ajax/charts_google.html';
    //    ajax_url = 'Home/Home';
    //}

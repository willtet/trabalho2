...
var $tableGroupStatus = $('#tblRelAgrupadoStatus');
var $tableResumoTotal = $('#tblRelResumoTotal');
var $tableTotalCampanha = $('#tblRelTotalCampanha');
...
var nomeRelatorio = 'RelatorioResumoGeral';
var nomeDataset = 'dsRelatorioResumoGeral';
...
function CarregarGrid(params) {
    ...
    $.ajax({
        ...
        url: '/relVdGeral/CarregarGridConsulta',
        type: 'GET',
        dataType: 'json',
        cache: false,
        data: params,
...
function LimparGrid() {
    ...
    $tableGroupStatus.bootstrapTable('destroy');
    $tableGroupStatus.bootstrapTable();
    $tableGroupStatus.show();

    $tableResumoTotal.bootstrapTable('destroy');
    $tableResumoTotal.bootstrapTable();
    $tableResumoTotal.show();

    $tableTotalCampanha.bootstrapTable('destroy');
    $tableTotalCampanha.bootstrapTable();
    $tableTotalCampanha.show();
}